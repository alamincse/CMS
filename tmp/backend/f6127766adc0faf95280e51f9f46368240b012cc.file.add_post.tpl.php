<?php /* Smarty version Smarty-3.1.16, created on 2014-12-04 18:27:13
         compiled from "C:\xampp\htdocs\myphpsite\CMS\template\backend\add_post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3024553d3dbfb52af92-69179906%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6127766adc0faf95280e51f9f46368240b012cc' => 
    array (
      0 => 'C:\\xampp\\htdocs\\myphpsite\\CMS\\template\\backend\\add_post.tpl',
      1 => 1417714030,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3024553d3dbfb52af92-69179906',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_53d3dbfb577dd8_43795556',
  'variables' => 
  array (
    'newcategory' => 0,
    'errors' => 0,
...
<?php if ($_valid && !is_callable('content_53d3dbfb577dd8_43795556')) {function content_53d3dbfb577dd8_43795556($_smarty_tpl) {?><div class="container content thumbnail">
	<div class="row">
		<div class="span3">
...
?>
				...
				<form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="content" class="span8" rows="15" placeholder="Post content"  onfocus="if(this.placeholder=='Post content'){this.placeholder=''}" onblur="if(this.placeholder==''){this.placeholder='Post content'}"  /></textarea>
						</div> <!--   .controls  -->
					</div> <!--  .control-group  -->
