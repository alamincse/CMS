 ...
 */
	...
	$search_form_title = archiveSearch();

	$smarty->assign('site_name', $seo['site_name']);
	$smarty->assign('site_title', $seo['site_title']);
	$smarty->assign('page_name', 'search');
	$smarty->assign('search_title', $search_form_title['archive'] );
	...
	$smarty->assign('recent_comments', comments());
	$smarty->assign('total_download', download_count());
	$smarty->assign('data_search', archiveSearch());
